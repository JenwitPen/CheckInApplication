        ...
        new AsyncTask<Void, Void, String>()
        {
            ...
            private String fetchCityNameUsingGoogleMap()
            {
                ...
                String googleMapUrl = "http://maps.googleapis.com/maps/api/geocode/json?latlng=" + latitude + ","
                        + longitude + "&sensor=false&language=th";
                // Creating service handler class instance
                ServiceHandler sh = new ServiceHandler();

                // Making a request to url and getting response
                String jsonStr = sh.makeServiceCall(googleMapUrl, ServiceHandler.GET);
                try
                {
                    JSONObject googleMapResponse = new JSONObject(jsonStr);
